...
<div id="product-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<div class="container">
				<div class="book-detail col-md-10 col-sm-10 col-xs-12 book-center">
					...
					<div class="book-item-detail col-md-7 col-sm-7 col-xs-12">
						...
						<div class="row">
							...
							<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
								<ul class="social-share">
									<?php $pinImage = $image_links;
									?>
										<li><?php _e('Share:', 'bebostore'); ?></li>
		                ...
		                ?>
		                <?php if($product_type == "product_sound_cloud") printf('%s', $mediaPlay); ?>
						<?php
	...
	<?php $author = get_field('field_book_author'); ?>
  	<?php if( $author ):?>
	<section>
		<div class="detail-author-book">
			<div class="container">
				...
				<div class="box-meet-author col-lg-6 col-md-5 col-sm-6 col-xs-12">
					<div class="title-box meet-box"><span><?php _e('Meet the Author','bebostore'); ?></span></div>
				...
				<div class="box-author-book col-lg-6 col-md-7 col-sm-6 col-xs-12">
					...
					<div class="clearfix"></div>
					<div id="<?php echo esc_attr($idauth);?>" class="swiper-container author-book-slider slider-with-scroll swiper-free-mode">
						    ...
						    <div class="swiper-wrapper" style="height: 202px;">
						        <!-- Slides -->
						        <div class="swiper-slide swiper-slide-visible swiper-slide-active" <?php print($style); ?>>
						        	 <?php while ( $loop->have_posts() ) : $loop->the_post();?>
						        	 	<?php
						        	 		$none_book = get_post_meta( get_the_ID(),'_beautheme_product_none_book', TRUE);
									        $style_product_item = '';
						...
						<script>
							(function($) {
								...
								var bookAuthor_<?php echo esc_js($rand_id); ?> = new Swiper('#<?php echo esc_js($idauth);?>', {
								    ...
								    scrollbar: {
								      container: '#<?php echo esc_js($idauth);?> .author-book-scrollbar',
								      scrollbar: <?php print($width_scroll); ?>
								    }
								  });
							})(jQuery);
						</script>
