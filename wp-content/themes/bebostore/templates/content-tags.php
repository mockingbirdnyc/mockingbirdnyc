...
<section class="section-blog-detail blogs-detail-full">
	<div class="container">
		<div class="left-cols book-center col-md-8 col-sm-8 col-xs-12">
			<div id="post-detail-<?php the_ID();?>" <?php post_class("page-blogs-grid section-landing-view blogs-detail");?>>
				...
				<div class="news-tags"><?php the_tags();?></div><!--End news-content-->
			</div><!--End blog-list-->
	...
	<div class="landing-book-blog">
		<div class="container">
			...
			<ul class="landing-list-news list-other-news">
				...
				?>
					<li class="news-item">
						<a href="<?php echo esc_url(get_the_permalink());?>" class="news-landing-book"><?php printf('%s',get_the_post_thumbnail(get_the_ID(), 'post-other-thumbnail'))?></a>
						<div>
