		...
		class ReduxFramework_extension_repeater {
			...
			public function __construct( $parent ) {
				...
				// Adds the local field
			 	add_action( 'redux/'.$this->parent->args['opt_name'].'/field/class/' . $this->field_name, array( $this, 'overload_field_path' ) );
			}

			static public function getInstance() {
					if ( null === self::$theInstance ) {
			...
			public function overload_field_path( $field ) {
				return BEAU_CORE_PATH.'/includes/libs/redux/extensions/repeater/field_repeater.php';
			}
